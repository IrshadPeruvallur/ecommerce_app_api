                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: image ?? AssetImage('assets/images/dummy.jpg'),
                          fit: BoxFit.cover),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                            onPressed: () {},
                            icon: Icon(EneftyIcons.minus_square_outline)),
                        Text(
                          "05",
                          style: TextStyle(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                        elevation: MaterialStateProperty.all(size.width * .07),
                      ...
                      onPressed: () {},
                      child: Icon(EneftyIcons.heart_outline),
                    ),
                  ),
                  SizedBox(
                    height: size.width * .14,
